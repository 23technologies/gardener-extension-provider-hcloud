...
func NewInfrastructureConfigSpec() *hcloud.InfrastructureConfig {
	return &hcloud.InfrastructureConfig{
		Networks: &hcloud.Networks{
			Workers: TestInfrastructureWorkersNetworkCidr,
		},
	}
}
