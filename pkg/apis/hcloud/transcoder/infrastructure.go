...
// given RawExtension.
func DecodeInfrastructureConfig(infra *runtime.RawExtension) (*hcloud.InfrastructureConfig, error) {
...
func DecodeInfrastructureConfigWithDecoder(decoder runtime.Decoder, infra *runtime.RawExtension) (*hcloud.InfrastructureConfig, error) {
...
func DecodeInfrastructureConfigFromCluster(cluster *controller.Cluster) (*hcloud.InfrastructureConfig, error) {
...
// Infrastructure.
func DecodeInfrastructureConfigFromInfrastructure(infra *v1alpha1.Infrastructure) (*hcloud.InfrastructureConfig, error) {
...
// given RawExtension.
func DecodeInfrastructureStatus(infra *runtime.RawExtension) (*hcloud.InfrastructureStatus, error) {
...
func DecodeInfrastructureStatusFromInfrastructure(infra *v1alpha1.Infrastructure) (*hcloud.InfrastructureStatus, error) {
