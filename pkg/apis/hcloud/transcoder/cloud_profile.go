...
// RawExtension.
func DecodeCloudProfileConfig(profile *runtime.RawExtension) (*api.CloudProfileConfig, error) {
...
func DecodeCloudProfileConfigWithDecoder(decoder runtime.Decoder, profile *runtime.RawExtension) (*api.CloudProfileConfig, error) {
...
func DecodeCloudProfileConfigFromControllerCluster(cluster *controller.Cluster) (*api.CloudProfileConfig, error) {
...
func DecodeCloudProfileConfigFromGardenContext(ctx context.Context, webhookcontext webhookcontext.GardenContext) (*api.CloudProfileConfig, error) {
...
func DecodeConfigFromCloudProfile(profile *v1beta1.CloudProfile) (*api.CloudProfileConfig, error) {
	if profile == nil {
...
// is returned.
func DecodeMachineImageNameFromCloudProfile(cpConfig *api.CloudProfileConfig, imageName, imageVersion string) (string, error) {
	if cpConfig != nil {
