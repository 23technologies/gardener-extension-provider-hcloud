...
func (w *workerDelegate) updateMachineDependenciesStatus(ctx context.Context, workerStatus *apis.WorkerStatus, placementGroupIds map[string]int, err error) error {
