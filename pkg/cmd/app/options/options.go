...
import (
	...
	"github.com/23technologies/gardener-extension-provider-hcloud/pkg/controller/infrastructure"
...
func NewControllerManagerCommand(ctx context.Context) *cobra.Command {
	...
	cmdDefinition := &cobra.Command{
		...
		Run: func(cmdDefinition *cobra.Command, args []string) {
			...
			configFileOpts.Completed().ApplyGardenId(&infrastructure.DefaultAddOptions.GardenId)
